...
class PredatoryCreditCard(CreditCard):
    ...
    def charge(self, price):
        ...
        PredatoryCreditCard.CHARGE_TIMES += 1
    ...
    def process_month(self):
        ...
        if PredatoryCreditCard.CHARGE_TIMES > 10:
            self._balance += 1 * (PredatoryCreditCard.CHARGE_TIMES - 10) 
...
if __name__ == "__main__":
    ...
    prd = PredatoryCreditCard("John Bowman", "California Finance", "2234 4322 3443 3434", 5000, 0.00825)
